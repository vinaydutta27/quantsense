...
const appPages = ['sensitivities.html', 'credit.html', 'simm.html', 'treasury-risk.html', 'stochastic.html', 'frtb.html', 'cva.html', 'saccr.html', 'xva.html', 'irrbb.html', 'yield.html', 'liquidity.html'];
const seoPages = ['index.html', 'about.html', 'contact.html', 'contact-thanks.html', 'faq.html', 'glossary.html', 'learning-paths.html', 'methodology.html', 'privacy.html'];
...
const learning = ['Risk sensitivities', 'Credit risk · IFRS 9', 'SIMM · Initial margin', 'Treasury · Balance-sheet risk', 'Stochastic calculus', 'FRTB · Market risk', 'SA-CVA · Counterparty risk', 'SA-CCR · Exposure', 'XVA · Valuation adjustments', 'IRRBB · Banking book', 'Yield curves · Bootstrapping', 'Liquidity · Funding risk', 'FRTB Regulation Divergences'];
