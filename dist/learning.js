  ...
  window.renderLearning = id => {
    ...
    target.innerHTML = `
      <section class="intuition-section" aria-labelledby="intuition-heading">
        <div class="learning-heading"><span class="mini">GO BEYOND THE FORMULA</span><h2 id="intuition-heading">Understand the concept</h2></div>
      ...
      <section class="question-section" aria-labelledby="questions-heading">
        ...
        <ol class="concept-questions">${content.questions.map(([question, answer], i) => `
          <li><details><summary><span class="question-number" aria-hidden="true">${String(i + 1).padStart(2, '0')}</span><span>${escape(question)}</span><span class="question-toggle" aria-hidden="true">+</span></summary><div class="suggested-answer"><strong>Suggested explanation</strong><p>${escape(answer)}</p></div></details></li>`).join('')}
        </ol>
      </section>`;
  };
})();
